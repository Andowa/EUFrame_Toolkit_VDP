...
(function($) {
  ...
  var weburl=document.location.protocol+"//"+document.domain+":"+location.port+"/";
  }else{
  var weburl=window.ROOTPATH+"/";
  }
  ...
  $.localize = function(pkg, options) {
    ...
    jsonCall = function(file, pkg, lang, level) {
      ...
      if (options.pathPrefix != null) {
        file = weburl+"" + options.pathPrefix + "/" + file;
      }
    ...
    localizeForSpecialKeys = function(elem, value) {
      ...
      return setTextFromValueForKey(elem, "lang", value);
    };
